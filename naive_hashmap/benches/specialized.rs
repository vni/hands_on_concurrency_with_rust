...
macro_rules! insert_lookup {
    ($fn:ident, $s:expr) => {
        fn $fn(c: &mut Criterion) {
            ...
            let specialized = Fun::new("specialized", |b, i| {
                b.iter(|| insert_and_lookup_specialized(*i))
            });

            let functions = vec![naive, standard, specialized];
...
criterion::criterion_group! {
    ...
    targets = insert_lookup_100000, insert_lookup_10000, insert_lookup_1000,
              insert_lookup_100, insert_lookup_10, insert_lookup_1
}
